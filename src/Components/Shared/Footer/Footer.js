                ...
                <div className="container-fluid text-white pt-5 pb-2">
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            <h5 className='mb-4'>Imformation</h5>
                            <p>About</p>
                    ...
                    <div className="d-flex">
                        <h5>Brands:</h5>
                        <p className='ms-5'>Apple</p>
                        <p className='ms-5'>Asus</p>
                        <p className='ms-5'>Boos</p>
                        <p className='ms-5'>Cannon</p>
                    </div>
                    <hr />
                    <p className="text-center pt-4">Copy right by Best Furniture &copy; {(new Date().getFullYear())}</p>
                </div>
            </div>
        </div>
    );
